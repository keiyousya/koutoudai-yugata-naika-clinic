...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS inventory_items (
    ...
    order_threshold INTEGER NOT NULL DEFAULT 5,
  ...
  `INSERT OR IGNORE INTO inventory_items (category_id, name, dosage, unit, sort_order) VALUES
    ...
    (2, '翼状針23G', NULL, '個数', 4),
    (2, 'シュアホルダ', NULL, '個数', 5),
    (2, '輸液：ラクテック', NULL, '個数', 6),
    (2, '輸液：生理食塩水', NULL, '個数', 7),
    (2, '輸液：１号液', NULL, '個数', 8),
    (2, '輸液：３号液', NULL, '個数', 9),
    (2, '輸液固定フィルム', NULL, '個数', 10),
    (2, '消毒綿', NULL, '個数', 11),
    (2, '優肌絆', NULL, '個数', 12),
    (2, 'シリンジ：10ml', NULL, '個数', 13),
    (2, 'シリンジ：1ml', NULL, '個数', 14),
    (2, '注射針：18G', NULL, '個数', 15),
    (2, '注射針：22G', NULL, '個数', 16),
    (2, '採血管：血算', NULL, '個数', 17),
    (2, '採血管：生化', NULL, '個数', 18),
    (2, '採血管：凝固', NULL, '個数', 19),
    (2, '尿スピッツ', NULL, '個数', 20),
    (2, '尿スピッツ（クラミジア・淋菌）', NULL, '個数', 21),
    (2, '便培養', NULL, '個数', 22),
    (2, '痰培養', NULL, '個数', 23),
    (2, '便潜血', NULL, '個数', 24),
    (2, '止血用の絆創膏', NULL, '個数', 25),
    (2, '手袋：S', NULL, '個数', 26),
    (2, '手袋：M', NULL, '個数', 27),
    (2, 'サージカルマスク', NULL, '個数', 28),
    (2, '診察台用シーツ', NULL, '個数', 29),
    (2, 'ペーパーシーツ', NULL, '個数', 30),
    (2, '舌圧子', NULL, '個数', 31),
    (2, '耳鏡', NULL, '個数', 32),
    (2, '不織布ガーゼ', NULL, '個数', 33),
    (2, '医療廃棄物：針ボックス', NULL, '個数', 34),
    (2, '医療廃棄物：感染性廃棄物箱', NULL, '個数', 35),
    (2, '迅速検査キット：flu/cov', NULL, '個数', 36),
    (2, '迅速検査キット：strep', NULL, '個数', 37),
    (2, '迅速検査キット：myco', NULL, '個数', 38),
    (2, '尿カップ', NULL, '個数', 39),
    (2, '尿検査用試験紙', NULL, '個数', 40),
    (2, '血糖測定用チップ・針', NULL, '個数', 41),
    (2, 'OS-1', NULL, '個数', 42)`,

  // 発注対象の初期設定（医薬品は全品目、備品は迅速検査キットのみ）
